...
| `spectrometer-json/`          | JSON schema and documentation for FTIR spectrometer measurements, including: readme, schema, example JSON, schema documentation and diagram. |
